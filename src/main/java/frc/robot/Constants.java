...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static double kSpeedLimiter = 1;
    ...
    //public static final double driveRadius =Units.inchesToMeters(17.4567); // the pathagorean therom with width and base both halfed
